      ...
      <section className="py-12 sm:py-16">
        <Container>
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-semibold text-ink">
              More planning content is coming soon.
            </h2>
            <p className="mt-4 leading-7 text-muted">
              BuildMetric will add detailed chicken coop planning guides after
              the MVP launches. No placeholder article links are published until
              those pages exist.
            </p>
          </div>
        </Container>
