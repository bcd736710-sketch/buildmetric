...
export function CategoryProductCard({ product, fallbackImage }: CategoryProductCardProps) {
  ...
  return <article className="group">
    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden bg-mist">
        <div className="absolute inset-0 flex items-center justify-center">
          <Image
            alt={seo?.imageAlt || `${product.name} product view`}
    ...
    <div className="flex min-h-[150px] flex-col pt-4 sm:min-h-[166px]">
      ...
      <p className="mt-2 text-sm text-slate">{seo?.shortDescription || product.shortDescription || "Contact TROVANE for model-specific product and order details."}</p>
