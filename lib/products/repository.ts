...
type ProductRow = {
  ...
  certifications: string | null; moq: string | null; material: string | null; size_specs: string | null; finish: string | null; available_options: string | null; wholesale_supply_description: string | null;
...
const productColumns = `
  ...
  p.certifications, p.moq, p.material, p.size_specs, p.finish, p.available_options, p.wholesale_supply_description,
...
function mapProduct(row: ProductRow): Product {
  return {
    ...
    moq: row.moq, material: row.material, sizeSpecs: row.size_specs, finish: row.finish, availableOptions: row.available_options, wholesaleSupplyDescription: row.wholesale_supply_description, specifications: row.specifications ?? {},
