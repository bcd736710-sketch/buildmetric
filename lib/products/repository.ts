...
type ProductRow = {
  ...
  certifications: string | null; moq: string | null; material: string | null; size_specs: string | null;
...
const productColumns = `
  ...
  p.certifications, p.moq, p.material, p.size_specs,
...
function mapProduct(row: ProductRow): Product {
  return {
    ...
    moq: row.moq, material: row.material, sizeSpecs: row.size_specs, specifications: row.specifications ?? {},
